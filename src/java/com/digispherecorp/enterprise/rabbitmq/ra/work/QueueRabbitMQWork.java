 ...
 * @author walle
 */
public class QueueRabbitMQWork extends RabbitMQWork {
    ...
    public QueueRabbitMQWork(WorkManager workManager, MessageEndpointFactory endpointFactory, ActivationSpec spec, EndPointActivationCapsule capsule) {
